var disp=document.getElementById("disp");function ud(e){disp.innerHTML+=e}function ans(){c=eval(disp.innerHTML),disp.innerHTML=c}function clc(){disp.innerHTML=""}document.getElementById("1").addEventListener("click",function(){ud(1)}),document.getElementById("2").addEventListener("click",function(){ud(2)}),
